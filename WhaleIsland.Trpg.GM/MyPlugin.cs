...
using WhaleIsland.Trpg.GM.Common.Runtime;
...
namespace WhaleIsland.Trpg.GM
{
    ...
    public class MyPlugin : CQAppAbstract
    {
        ...
        public override void Startup()
        {
            ...
            CacheFactory.Initialize(cacheSetting, setting.Serializer);
        ...
        public override void GroupMessage(int subType, int sendTime, long fromGroup, long fromQQ, string fromAnonymous, string msg, int font)
        {
            ...
            GMService.Received(groupMember.QQNumber, groupMember.QQName, msg);
        }
